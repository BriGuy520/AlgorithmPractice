// You managed to send your friend to queue for tickets in your stead, but there is a 
// catch: he will get there only if you tell him how much that is going to take. And everybody 
// can only take one ticket at a time, then they go back in 
...
function queue(queuers, pos){
  ...
  while(ticketsNeeded > 0){
    ...
    } else if(idx < queuers.length && idx == pos){
      ticketsNeeded--;
      time++;
      queuers[idx]--;
      idx++;
